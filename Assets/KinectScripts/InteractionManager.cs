...
public class InteractionManager : MonoBehaviour 
{
	...
	private static Vector3 lastRightHandPos = Vector3.zero;
	private static float lastRightHandTime = 0f;
	private static bool isRightHandClick = false;
	private static float rightHandClickProgress = 0f;
	...
	public static bool IsRightHandClickDetected()
	{
		if(isRightHandClick)
		{
